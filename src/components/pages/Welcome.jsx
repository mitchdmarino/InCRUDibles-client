  ...
  return (
    <main>
      <div>
        ...
        <p className="text-white tracking-tight leading-6 text-2xl pb-8 h-48 ml-3 pr-70 mr-60 text-left">
        ...
        <p className="text-white tracking-tight leading-6 text-2xl pb-8 h-48 pl-70 ml-80 mr-5">
        ...
        <p className="text-white tracking-tight leading-6 text-2xl pb-4 h-48 ml-3 pr-70 mr-60">
