...
export default function Navbar({ currentAccount, handleLogout }) {
  ...
  return (
    ...
    //       <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SITE NAME</span>
    //     </Link>
    //     {/* on smaller screens, there will be a dropdown menu to select navbar options */}
